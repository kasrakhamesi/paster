...
function DashboardLayout({ children }: { children: ReactNode }) {
    ...
    const switchSidebar = () => { setToggler(!toggler) }



    return (
        <div
            className='flex flex-col w-full h-full min-h-screen lg:flex-row bg-base-100 font-Gilroy '
        >
            ...
            <main
                className={`w-full p-2 lg:p-8 min-h-screen h-full flex   ${toggler ? 'overflow-y-hidden' : ''
                    }`}
            >
                {children}
            </main>
